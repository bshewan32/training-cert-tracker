...
const MultiPositionComplianceDashboard = ({ token }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const setupResponse = await fetch(`/api/setup?includeInactive=${includeInactiveEmployees}`, {
        headers: {
      ...
      const archivedResponse = await fetch('/api/setup/archived-employees', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      ...
      const reqResponse = await fetch('/api/positionRequirements', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const archiveEmployee = async (employeeId) => {
    try {
      const response = await fetch(`/api/setup/employee/${employeeId}/archive`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const reactivateEmployee = async (employeeId) => {
    try {
      const response = await fetch(`/api/setup/employee/${employeeId}/reactivate`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        }
